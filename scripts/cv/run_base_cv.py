...
parser.add_argument('--lora_r_server', type=int, default=4, help='LoRA（：4）')
...
parser.add_argument('--algorithm', type=str, default='FEDIT', choices=['FEDIT', 'FLORA', 'ILORA', 'LoRA_FAIR', 'FFA-LORA'], help='（：FEDIT）')
parser.add_argument('--save_dir', type=str, default='/path/to/save_dir', help='（：/path/to/save_dir）')
parser.add_argument('--dataset', type=str, default='cifar10', choices=['cifar10', 'cifar100', 'MNIST', 'STL10', 'SVHN', 'tiny-imagenet-200'], help='（：cifar10）')
...
parser.add_argument('--heterogeneous_rank', type=str, default='False', choices=['True', 'False'], help='True，False')
