...
parser.add_argument('--dataset', type=str, default='QQP', choices=['QQP', 'MNLI', 'STS-B', 'WNLI', 'RTE', 'MRPC', 'qnli', 'cola', 'sst2', 'SNLI', 'IMDB', 'AG_NEWS', 'DBPedia', 'ANLI', 'PAWS', 'AMAZON_POL', 'DBPEDIA14', 'YELP_POLARITY', 'YAHOO_ANS', 'TREC', 'SICK', 'YELP_REVIEW_FULL', '20NEWSGROUPS', 'EMOTION', 'sst5', 'MR', 'HateXplain'], help='（：DBPedia）')
...
parser.add_argument('--QR_init', type=str, default='Auto', choices=['Auto', 'True', 'False'], help='QR ：Auto=ILORA，；True=；False=（：Auto）')
...
if args.heterogeneous_rank == 'True':
    ...
    print(f': {args.heterogeneous_rank_clients}')
else:
    print('：')
...
def get_model(r):
    ...
    if enable_qr:
        print(f'[QR_init]  QR ：r={r}, scale_factor={args.lora_scale_factor}')
