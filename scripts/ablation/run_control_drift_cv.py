...
parser.add_argument('--cuda_device', type=str, default='2', help='CUDA device id.')
...
parser.add_argument('--lora_r_server', type=int, default=4, help='Server LoRA rank.')
...
parser.add_argument('--heterogeneous_rank', type=str, default='False', choices=['True', 'False'], help='Whether to use heterogeneous LoRA ranks.')
