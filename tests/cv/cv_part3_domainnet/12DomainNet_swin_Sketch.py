...
if __name__ == '__main__':
    training_commands = ['python main_fl_domainNet.py --cuda_device 3 --lora_r_client 4 --lora_r_server 6 --model_name swin-base-patch4-window7-224 --num_rounds 50 --lr 0.001 --local_epochs 1 --batch_size 64 --num_clients 3 --algorithm FEDIT --dataset domainnet_sketch --save_dir /home/pr3022206045/code/LORA+SAM5_cifar10/DomainNet12/1/ --training_mode Homo --optimizer AdamW --distribution NON-IID --heterogeneous_rank True --use_control False --alpha 0.6 --heterogeneous_rank_clients "2,4,6"', 'python main_fl_domainNet.py --cuda_device 3 --lora_r_client 4 --lora_r_server 12 --model_name swin-base-patch4-window7-224 --num_rounds 50 --lr 0.001 --local_epochs 1 --batch_size 64 --num_clients 3 --algorithm FLORA --dataset domainnet_sketch --save_dir /home/pr3022206045/code/LORA+SAM5_cifar10/DomainNet12/2/ --training_mode Homo --optimizer AdamW --distribution NON-IID --heterogeneous_rank True --use_control False --alpha 0.6 --heterogeneous_rank_clients "2,4,6"', 'python main_fl_domainNet.py --cuda_device 3 --lora_r_client 4 --lora_r_server 6 --model_name swin-base-patch4-window7-224 --num_rounds 50 --lr 0.001 --local_epochs 1 --batch_size 64 --num_clients 3 --algorithm LoRA_FAIR --dataset domainnet_sketch --save_dir /home/pr3022206045/code/LORA+SAM5_cifar10/DomainNet12/3/ --training_mode Homo --optimizer AdamW --distribution NON-IID --heterogeneous_rank True --use_control False --alpha 0.6 --heterogeneous_rank_clients "2,4,6"', 'python main_fl_domainNet.py --cuda_device 3 --lora_r_client 4 --lora_r_server 6 --model_name swin-base-patch4-window7-224 --num_rounds 50 --lr 0.001 --local_epochs 1 --batch_size 64 --num_clients 3 --algorithm FFA-LORA --dataset domainnet_sketch --save_dir /home/pr3022206045/code/LORA+SAM5_cifar10/DomainNet12/4/ --training_mode Homo --optimizer AdamW --distribution NON-IID --heterogeneous_rank True --use_control False --alpha 0.6 --heterogeneous_rank_clients "2,4,6"', 'python main_fl_domainNet.py --cuda_device 3 --lora_r_client 4 --lora_r_server 6 --model_name swin-base-patch4-window7-224 --num_rounds 50 --lr 0.001 --local_epochs 1 --batch_size 64 --num_clients 3 --algorithm ILORA --dataset domainnet_sketch --save_dir /home/pr3022206045/code/LORA+SAM5_cifar10/DomainNet12/5/ --training_mode Homo --optimizer AdamW --distribution NON-IID --heterogeneous_rank True --use_control False --alpha 0.6 --heterogeneous_rank_clients "2,4,6" --lora_scale_factor 1', 'python main_fl_domainNet.py --cuda_device 3 --lora_r_client 4 --lora_r_server 6 --model_name swin-base-patch4-window7-224 --num_rounds 50 --lr 0.001 --local_epochs 1 --batch_size 64 --num_clients 3 --algorithm ILORA --dataset domainnet_sketch --save_dir /home/pr3022206045/code/LORA+SAM5_cifar10/DomainNet12/6/ --training_mode Homo --optimizer AdamW --distribution NON-IID --heterogeneous_rank True --use_control True --alpha 0.6 --heterogeneous_rank_clients "2,4,6" --lora_scale_factor 1']
